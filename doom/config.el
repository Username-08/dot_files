...
(add-to-list 'load-path "~/.emacs.d/.local/straight/build-27.2/emacs-application-framework/")
(require 'eaf)
...
(require 'evil)
(setq evil-insert-state-cursor '(box "#d2b48c"))
(setq evil-normal-state-cursor '(box "#d2b48c"))
(setq evil-visual-state-cursor '(box "#d2b48c"))
(setq evil-replace-state-cursor '(box "#d2b48c"))
(setq evil-emacs-state-cursor '(box "#d2b48c"))
(setq evil-motion-state-cursor '(box "#d2b48c"))
(setq evil-operator-state-cursor '(box "#d2b48c"))
