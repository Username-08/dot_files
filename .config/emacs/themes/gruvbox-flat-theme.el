;; gruvbox-flat-theme.el --- inspired by morhetz Gruvbox -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(defgroup gruvbox-flat-theme nil
  "Options for gruvbox-flat."
  :group 'doom-themes)

(defcustom gruvbox-flat-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'gruvbox-flat-theme
  :type 'boolean)

(defcustom gruvbox-flat-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'gruvbox-flat-theme
  :type '(choice integer boolean))

(defcustom gruvbox-flat-dark-variant nil
...
(def-doom-theme gruvbox-flat
  ...
  ;; name        gui       256       16
  ((bg
    (cond ((equal gruvbox-flat-dark-variant "hard") '("#32302f" "#1e1e1e" nil))   ; bg0_h
          ((equal gruvbox-flat-dark-variant "soft") '("#32302f" "#323232" nil))   ; bg0_s
          (t                                        '("#32302f" "#282828" nil)))) ; bg0
   (bg-alt
    (cond ((equal gruvbox-flat-dark-variant "hard") '("#32302f" "black" nil))     ; (self-defined)
          ((equal gruvbox-flat-dark-variant "soft") '("#32302f" "#282828" nil))   ; bg0
   ...
   (base7      '("#d2b48c" "#cccccc" "brightblack")) ; fg2
   (base8      '("#d2b48c" "#fbfbfb" "brightwhite")) ; fg0
   (fg         '("#d2b48c" "#dfdfdf" "brightwhite")) ; fg/fg1
   (fg-alt     '("#d2b48c" "#cccccc" "brightwhite")) ; fg2

   ;; Standardized official colours from gruvbox
   (grey        '("#5a524c" "#909090" "brightblack"))   ; gray
   (red         '("#ea6962" "#e74c3c" "red"))           ; bright-red
   (magenta     '("#d3869b" "#cc241d" "magenta"))       ; red
   (violet      '("#7daea3" "#d3869b" "brightmagenta")) ; bright-purple
   (orange      '("#e78a4e" "#fd971f" "orange"))        ; bright-orange
   (yellow      '("#d8a657" "#fabd2f" "yellow"))        ; bright-yellow
   (dark-yellow '("#b47109" "#fabd2f" "yellow"))        ; yellow
   ...
   (selection      bg-alt2)
   (builtin        red)
   (comments       (if gruvbox-flat-brighter-comments magenta base5))
   (doc-comments   (if gruvbox-flat-brighter-comments (doom-lighten magenta 0.2) base5))
   (constants      yellow)
   (functions      blue)
   (keywords       magenta)
   (methods        cyan)
   ...
   ;; custom categories
   (-modeline-pad
    (when gruvbox-flat-padded-modeline
      (if (integerp gruvbox-flat-padded-modeline)
          gruvbox-flat-padded-modeline
        4)))
   (modeline-bg bg-alt2)
   (modeline-fg (doom-lighten fg-alt 0.00))
  ...
  ((button :foreground cyan :underline t :weight 'bold)
   ...
   ((line-number-current-line &override) :background base3 :foreground magenta)
   ...
   ;;;; font-lock
   (font-lock-bracket-face :foreground orange)
   (font-lock-delimiter-face :foreground orange)
   (font-lock-operator-face :foreground orange)

   ;;;; company
   (company-preview-common :foreground fg)
   (company-tooltip-common :foreground fg)
   (company-tooltip :foreground grey)
   (company-tooltip-common-selection :foreground bg)
   ...
   (company-tooltip-selection :background green :foreground bg)
   (company-tooltip-mouse :background green :foreground bg)
   ...
   (doom-themes-neotree-hidden-file-face :foreground (doom-lighten fg-alt 0.00))
   (doom-themes-neotree-media-file-face :foreground (doom-lighten fg-alt 0.00))
   ;;;; emacs-lisp-mode
   ...
   (web-mode-json-context-face     :foreground red)
   ;;;; which-key
...
;;; gruvbox-flat-theme.el ends here
